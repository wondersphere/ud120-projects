...
dir_path = os.path.join(os.getcwd(), "tools")

#def preprocess(words_file = "../tools/word_data.pkl", authors_file="../tools/email_authors.pkl"):
def preprocess(words_file = os.path.join(dir_path, "word_data.pkl"), authors_file= os.path.join(dir_path, "email_authors.pkl")):
    """ 
